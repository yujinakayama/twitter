...
describe Twitter::API do
  ...
  describe "#suggestions" do
    context "with a category slug passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/users/suggestions/art-design.json")).
          to have_been_made
      end
    ...
    context "without arguments passed" do
      ...
      it "requests the correct resource" do
        @client.suggestions
        expect(a_get("/1.1/users/suggestions.json")).
          to have_been_made
      end
  ...
  describe "#suggest_users" do
    ...
    it "requests the correct resource" do
      ...
      expect(a_get("/1.1/users/suggestions/art-design/members.json")).
        to have_been_made
    end
  ...
  describe "#user_search" do
    ...
    it "requests the correct resource" do
      ...
      expect(a_get("/1.1/users/search.json").
        with(:query => {:q => "Erik Michaels-Ober"})).
        to have_been_made
    end
  ...
  describe "#contributees" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/users/contributees.json").
          with(:query => {:screen_name => "sferik"})).
          to have_been_made
      end
  ...
  describe "#contributors" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/users/contributors.json").
          with(:query => {:screen_name => "sferik"})).
          to have_been_made
      end
  ...
  describe "#following_followers_of" do
    context "with a screen_name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/users/following_followers_of.json").
          with(:query => {:cursor => "-1", :screen_name => "sferik"})).
          to have_been_made
      end
