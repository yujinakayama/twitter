...
describe Twitter::API do
  ...
  describe "#list_timeline" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/statuses.json").
          with(:query => {:owner_screen_name => 'sferik', :slug => 'presidents'})).
          to have_been_made
      end
  ...
  describe "#list_remove_member" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/members/destroy.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents', :user_id => "813286"})).
          to have_been_made
      end
  ...
  describe "#memberships" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/memberships.json").
          with(:query => {:screen_name => 'pengwynn', :cursor => "-1"})).
          to have_been_made
      end
  ...
  describe "#list_subscribers" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/subscribers.json").
          with(:query => {:owner_screen_name => 'sferik', :slug => 'presidents', :cursor => "-1"})).
          to have_been_made
      end
  ...
  describe "#subscriptions" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/subscriptions.json").
          with(:query => {:screen_name => 'pengwynn', :cursor => "-1"})).
          to have_been_made
      end
  ...
  describe "#list_subscribe" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/subscribers/create.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents'})).
          to have_been_made
      end
  ...
  describe "#list_subscriber?" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/subscribers/show.json").
          with(:query => {:owner_screen_name => 'sferik', :slug => 'presidents', :user_id => '813286'})).
          to have_been_made
      end
      it "returns true if the specified user subscribes to the specified list" do
        ...
        expect(list_subscriber).to be_truthy
      end
      it "returns false if the specified user does not subscribe to the specified list" do
        ...
        expect(list_subscriber).to be_falsey
      end
  ...
  describe "#list_unsubscribe" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/subscribers/destroy.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents'})).
          to have_been_made
      end
      it "returns the specified list" do
  ...
  describe "#list_add_members" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/members/create_all.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents', :user_id => "813286,18755393"})).
          to have_been_made
      end
      it "returns the list" do
  ...
  describe "#list_remove_members" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/members/destroy_all.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents', :user_id => "813286,18755393"})).
          to have_been_made
      end
      it "returns the list" do
  ...
  describe "#list_member?" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/members/show.json").
          with(:query => {:owner_screen_name => 'sferik', :slug => 'presidents', :user_id => '813286'})).
          to have_been_made
      end
      ...
      it "returns false if user is not a list member" do
        ...
        expect(list_member).to be_falsey
      end
      it "returns false if user does not exist" do
  ...
  describe "#list_members" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/members.json").
          with(:query => {:owner_screen_name => 'sferik', :slug => 'presidents', :cursor => "-1"})).
          to have_been_made
      end
  ...
  describe "#list_add_member" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/members/create.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents', :user_id => "813286"})).
          to have_been_made
      end
      it "returns the list" do
  ...
  describe "#list_destroy" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/destroy.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => 'presidents'})).
          to have_been_made
      end
  ...
  describe "#list_update" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_post("/1.1/lists/update.json").
          with(:body => {:owner_screen_name => 'sferik', :slug => "presidents", :description => "Presidents of the United States of America"})).
          to have_been_made
      end
  ...
  describe "#list_create" do
    ...
    it "requests the correct resource" do
      ...
      expect(a_post("/1.1/lists/create.json").
        with(:body => {:name => "presidents"})).
        to have_been_made
    end
  ...
  describe "#lists" do
    ...
    it "requests the correct resource" do
      @client.lists
      expect(a_get("/1.1/lists/list.json")).
        to have_been_made
    end
  ...
  describe "#list" do
    context "with a screen name passed" do
      ...
      it "requests the correct resource" do
        ...
        expect(a_get("/1.1/lists/show.json").
          with(:query => {:owner_screen_name => 'sferik', :slug => 'presidents'})).
          to have_been_made
      end
      it "returns the updated list" do
